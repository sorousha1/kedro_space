...
# prj_spaceflights documentation build
...
from prj_spaceflights import __version__ as release

# -- Project information -----------------------------------------------------

project = "prj_spaceflights"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "prj_spaceflightsdoc"
...
latex_documents = [
    (
        master_doc,
        "prj_spaceflights.tex",
        "prj_spaceflights Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "prj_spaceflights",
        "Project prj_spaceflights codebase.",
        "Data-Science",
    )
]
